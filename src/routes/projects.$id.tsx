...
function ProjectDetailRoute() {
  ...
  const ld = {
    ...
    image: proj.id === "elanza" ? "https://dealwithit.org.in/projects/elanza.jpeg" : "https://dealwithit.org.in/og-image.png",
  ...
  head: ({ loaderData, params }) => {
    ...
    return {
      meta: [
        ...
        { property: "og:image", content: proj?.id === "elanza" ? "https://dealwithit.org.in/projects/elanza.jpeg" : "https://dealwithit.org.in/og-image.png" },
        { property: "og:image:alt", content: title },
        { name: "twitter:card", content: "summary_large_image" },
        { name: "twitter:title", content: title },
        { name: "twitter:description", content: desc },
        { name: "twitter:image", content: proj?.id === "elanza" ? "https://dealwithit.org.in/projects/elanza.jpeg" : "https://dealwithit.org.in/og-image.png" },
      ],
      links: [
